package com.wonly.lib_base.imageloader;

import android.content.Context;
import android.widget.ImageView;

import com.wonly.lib_base.imageloader.glide.GlideImageLoaderStrategy;
import com.wonly.lib_base.imageloader.glide.GlideImageOptions;

/**
 * @Author: HSL
 * @Time: 2019/9/2 11:16
 * @E-mail: xxx@163.com
 * @Description: 图片加载类 策略模式和建造者模式封装 ImageLoader ，默认使用 Glide
 */
